  ...
  return (
    <div className="min-h-screen bg-bg-navy text-white font-sans flex flex-col antialiased selection:bg-brand-orange selection:text-white">
      ...
      <AnimatePresence>
        ...
        <a
          href="https://wa.me/9779827679425"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 z-[999] flex flex-col items-center group cursor-pointer no-underline select-none"
          title="Contact Support on WhatsApp"
        >
          <div className="w-13 h-13 sm:w-14 sm:h-14 bg-[#25D366] hover:bg-[#22bf5b] text-white rounded-full flex items-center justify-center shadow-[0_4px_25px_rgba(37,211,102,0.5)] hover:shadow-[0_6px_30px_rgba(37,211,102,0.75)] hover:scale-110 active:scale-95 transition-all duration-300 border-2 border-white/30">
          ...
          <span className="text-[10px] font-black tracking-widest text-[#25D366] uppercase mt-1 px-2 py-0.5 rounded-full bg-black/80 border border-[#25D366]/40 shadow-md group-hover:scale-105 group-hover:bg-black transition-all">
            Contact
          </span>
        </a>
